...
if [ $? -ne 0 ]; then
  echo "Q2.7 training without FlashAttention and compile FAILED (continuing to Q2.8b)..."
fi


cd "${SCRIPT_DIR}" || exit 1
echo "====================================================================="
echo "Q2.7: Train LLM on 'Fairy Tales by Brothers Grimm' for 5 epochs with FlashAttention and compile"
echo "====================================================================="
(
  cd part2 || exit 0
...
if [ $? -ne 0 ]; then
  echo "Q2.7 training with FlashAttention and compile FAILED (continuing to Q2.8b)..."
fi
